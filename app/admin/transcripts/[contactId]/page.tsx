  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2 bg-white rounded-xl border border-slate-200 p-5 max-h-[70vh] overflow-y-auto brand-scroll animate-fade-in">
        ...
        <div className="space-y-4">
          ...
          <div className="animate-slide-up stagger-2 bg-white rounded-xl border border-slate-200 p-4 text-sm space-y-3 shadow-sm">
